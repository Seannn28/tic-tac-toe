...
export default class AboutUs extends React.Component {
  ...
  <div className="aboutpara">
      <h1>About Us</h1>
      <p>This game was made by Sean Snee, It is my first ever project using react. If you are unfamiliar with the game here is some information about it. 
      Tic-tac-toe (American English), noughts and crosses (British English), or Xs and Os is a paper-and-pencil game for two players, X and O, who take turns marking the spaces in a 3×3 grid.
       The player who succeeds in placing three of their marks in a horizontal, vertical, or diagonal row wins the game.Games played on three-in-a-row boards can be traced back to ancient Egypt, where such game boards have been found on roofing tiles dating from around 1300 BCE.
